	...
	<?php if ($mul ===1 || $mul === 6){echo '<div class="row taplist">';};?>
		<div class="col spina<?php echo $mul;?>">
			...
			<div class="row"><!-- Inizio row birrificio -->
				<div class="col-2 col-sm-1 numerospina"><?php if ($mul !=10){echo'0'.$mul;}else{echo $mul;};?>)</div><!-- .numerospina -->
				<?php get_template_part('template-parts/taplist/via','piena'); endwhile;else:?>
				<div class="row"><!-- Inizio row birrificio -->
					<div class="col-2 col-sm-1 numerospina"><?php if ($mul !=10){echo'0'.$mul;}else{echo $mul;};?>)</div><!-- .numerospina -->
