	...
	<div class="col spinauno">
		...
		<div class="row"><!-- Inizio row birrificio -->
			...
			<?php $et_spina_mille = get_post_meta( $post->ID, 'et2018-nome_birrificio', true );
				if ( ! empty ( $et_spina_mille ) ) {
					get_template_part( 'template-parts/taplist/via', 'piena' );
				} else {
					get_template_part( 'template-parts/taplist/via', 'vuota' );
				}; ?>
			<?php endwhile;
				else: ?>
			<div class="row"><!-- Inizio row birrificio -->
										...
										<div class="row taplist">
											<div class="col spinasei">
												...
												<?php if ( $catquery->have_posts() ) : while ( $catquery->have_posts() ) :
													$catquery->the_post(); ?>
												<div class="row"><!-- Inizio row birrificio -->
													<div class="col-6 col-sm-6 numerospina">06)</div>
													<!-- .numerospina -->
													<?php $et_spina_mille = get_post_meta( $post->ID, 'Birrificio', true );
														if ( ! empty ( $et_spina_mille ) ) {
															get_template_part( 'template-parts/taplist/via', 'piena' );
													...
													<div class="col spinasette">
														...
														<?php if ( $catquery->have_posts() ) : while ( $catquery->have_posts() ) :
															$catquery->the_post(); ?>
														<div class="row"><!-- Inizio row birrificio -->
															<div class="col-7 col-sm-7 numerospina">07)</div>
															<!-- .numerospina -->
															<?php $et_spina_mille = get_post_meta( $post->ID, 'Birrificio', true );
																if ( ! empty ( $et_spina_mille ) ) {
																	get_template_part( 'template-parts/taplist/via', 'piena' );
															...
															<div class="col spinaotto">
																...
																<?php if ( $catquery->have_posts() ) : while ( $catquery->have_posts() ) :
																	$catquery->the_post(); ?>
																<div class="row"><!-- Inizio row birrificio -->
																	<div class="col-8 col-sm-8 numerospina">08)</div>
																	<!-- .numerospina -->
																	<?php $et_spina_mille = get_post_meta( $post->ID, 'Birrificio', true );
																		if ( ! empty ( $et_spina_mille ) ) {
																			get_template_part( 'template-parts/taplist/via', 'piena' );
																	...
																	<div class="row"><!-- Inizio row birrificio -->
																		<div class="col-8 col-sm-8 numerospina">08)
																		</div><!-- .numerospina -->
																		<?php get_template_part( 'template-parts/taplist/via', 'vuota' ); ?>
																		<?php endif;
																			wp_reset_postdata(); ?>
																	...
																	<div class="col spinanove">
																		...
																		<?php if ( $catquery->have_posts() ) : while ( $catquery->have_posts() ) :
																			$catquery->the_post(); ?>
																		<div class="row"><!-- Inizio row birrificio -->
																			<div class="col-9 col-sm-9 numerospina">
																				09)
																			</div><!-- .numerospina -->
																			<?php $et_spina_mille = get_post_meta( $post->ID, 'Birrificio', true );
																				if ( ! empty ( $et_spina_mille ) ) {
																			...
																			<div class="col spinadieci">
																				...
																				<div class="row">
																					<!-- Inizio row birrificio -->
																					<div
																						class="col-10 col-sm-10 numerospina">
																						010)
																					</div><!-- .numerospina -->
																					<?php $et_spina_mille = get_post_meta( $post->ID, 'Birrificio', true );
																						if ( ! empty ( $et_spina_mille ) ) {
