	...
	<div class="row">
		<div class="col-xs-4 col-lg">
			<a href="#tagliere"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#tagliere" role="button">Tagliere &raquo;</a></p>
		</div><!-- /.col -->
		<div class="col-xs-4 col-lg">
			<a href="#antipasti"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#antipasti" role="button">Antipasti &raquo;</a></p>
		</div><!-- /.col -->
		<div class="col-xs-4 col-lg">
			...
			<p><a class="btn btn-outline-info btn-block" href="#bun" role="button">Hamburger &raquo;</a></p>
		</div><!-- /.col -->
		<div class="col-xs-4 col-lg">
			<a href="#piadina"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#piadina" role="button">Piadina &raquo;</a></p>
		</div><!-- /.col -->
	</div><div class="row">
		<div class="col-xs-4 col-lg">
			<a href="#crepe"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#crepe" role="button">Crêpes &raquo;</a></p>
		</div><!-- /.col -->
		<div class="col-xs-4 col-lg">
			<a href="#insalate"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#insalate" role="button">Insalate &raquo;</a></p>
		</div><!-- /.col -->
		<div class="col-xs-4 col-lg">
			<a href="#dolci"><img class="lazyload rounded-circle" style="margin-left: 25%"
				...
				/></a>
			<p><a class="btn btn-outline-info btn-block" href="#dolci" role="button">Dolci &raquo;</a></p>
		</div><!-- /.col -->
	</div><!-- /.row -->
</div><!-- .marketing -->