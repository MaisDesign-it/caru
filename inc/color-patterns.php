 ...
 */
function etimue2018_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Etimue 2018 default saturation level.
	 *
	 * @since Etimue 2018 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'etimue2018_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.etimue2018-front-page) .entry-title,
...
.colors-custom .etimue2018-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.etimue2018-front-page .panel-content .recent-posts article,
...
.colors-custom.etimue2018-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Etimue 2018 custom colors CSS.
	 *
	 * @since Etimue 2018 1.0
	 *
	 ...
	 */
	return apply_filters( 'etimue2018_custom_colors_css', $css, $hue, $saturation );
}
